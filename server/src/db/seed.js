...
async function seedDatabase() {
  try {
    ...
    const [subCentre, phc, chcSaswad, sdhBaramati, districtHospital, kemHospital] = await Facility.create([
      {
      ...
      {
        name: "Khandala Primary Health Centre (PHC Hub)",
      ...
      {
        name: "Saswad Community Health Centre (CHC Block Hospital)",
        facilityCode: "CHC-MH-PUN-005",
        tier: "chc",
        location: { village: "Saswad", block: "Purandar", district: "Pune", state: "Maharashtra", coordinates: { lat: 18.34, lng: 74.03 } },
        contactPhone: "+91 2115 222104",
        inChargeDoctor: "Dr. Sanjay Deshmukh, MS (General Surgery)",
        totalBeds: 30,
        availableBeds: 11,
        crowdLevel: "moderate",
        services: ["Minor Operation Theatre", "Emergency First Aid", "Dental Unit", "Pediatric Stabilization Ward", "Blood Storage Centre"],
        equipmentStatus: [
          { name: "Operation Theatre Laparoscopy", status: "working" },
          { name: "X-Ray 100mA Fixed", status: "working" },
          { name: "Oxygen Concentrator Dual", status: "working" },
          { name: "Defibrillator Monophasic", status: "working" },
        ],
        ambulanceAvailable: true,
        teleconsultCapable: true,
      },
      {
        name: "Baramati Sub-District Hospital (SDH Secondary Care)",
        facilityCode: "SDH-MH-PUN-002",
        tier: "chc",
        location: { village: "Baramati", block: "Baramati", district: "Pune", state: "Maharashtra", coordinates: { lat: 18.15, lng: 74.58 } },
        contactPhone: "+91 2112 244108",
        inChargeDoctor: "Dr. Arun Mehta, MD (Pediatrics), Medical Superintendent",
        totalBeds: 100,
        availableBeds: 24,
        crowdLevel: "moderate",
        services: ["24/7 BEmOC Maternal Center", "Neonatal Intensive Care (SNCU)", "Dialysis Unit", "General Surgery", "Orthopedic Emergency"],
        equipmentStatus: [
          { name: "Digital X-Ray DR System", status: "working" },
          { name: "Color Doppler Sonography", status: "working" },
          { name: "Dialysis Machines (4-bed)", status: "working" },
          { name: "Phototherapy LED Units", status: "working" },
        ],
        ambulanceAvailable: true,
        teleconsultCapable: true,
      },
      ...
      {
        name: "KEM Hospital & Medical Research Centre (Tertiary Hub)",
        facilityCode: "TH-MH-PUN-009",
        tier: "district-hospital",
        location: { village: "Rasta Peth", block: "Pune City", district: "Pune", state: "Maharashtra", coordinates: { lat: 18.52, lng: 73.87 } },
        contactPhone: "+91 20 6603 7300",
        inChargeDoctor: "Dr. Kavita Deshmukh, MD, DNB (Super-Specialty Lead)",
        totalBeds: 550,
        availableBeds: 68,
        crowdLevel: "critical",
        services: ["Cardiovascular Thoracic Surgery", "Comprehensive Burn Unit", "Pediatric Surgery", "Hemato-Oncology", "Advanced Tele-ICU Command"],
        equipmentStatus: [
          { name: "1.5 Tesla MRI Scanner", status: "working" },
          { name: "Cardiac Cath Lab", status: "working" },
          { name: "Extracorporeal Membrane Oxygenation (ECMO)", status: "working" },
          { name: "Apheresis Cell Separator", status: "working" },
        ],
        ambulanceAvailable: true,
        teleconsultCapable: true,
      },
    ...
    await Appointment.create([
      ...
      },
      {
        ...
        department: "Obstetrics & High-Risk Maternal OT",
